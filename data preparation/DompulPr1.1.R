...
telcoHourlyD1<-readRDS(file="telcoHourlyD1.Rds")

#3. subset data for specific Telco

#1) Axiata

KrakenBillerProductAxiata<-filter(telcoHourlyD1,productoperator %in% c("xl","axis"))
...
saveRDS(KrakenBillerProductAxiataDompul,file="/home/rstudio/KrakenBillerProductAxiataDompulD1.Rds",compress=F)
saveRDS(KrakenBillerProductAxiataDompulH,file="/home/rstudio/KrakenBillerProductAxiataDompulHD1.Rds",compress=F)
