...
#Data extraction script to obtain the Telco data for delta 1 (Thu-Sun) in weekly basis
...
TelcoHourlyQuery<-dbSendQuery(con,"select *
                              ...
                              date(now()+interval'7 hours')-interval'4 days' and 
...
saveRDS(telcoHourlyDd1,file="/home/rstudio/telcoHourlyD1.Rds",compress=F)
